...
RUN apt-get update && \
    ...
    sed -i "s,/usr/bin/contrail-analytics-api,/usr/bin/contrail-analytics-api --conf_file /var/lib/contrail/contrail-analytics-api.conf,g" /etc/contrail/supervisord_analytics_files/contrail-analytics-api.ini && \
    ...
    sed -i "s,/usr/bin/contrail-alarm-gen,/usr/bin/contrail-alarm-gen --conf_file /var/lib/contrail/contrail-alarm-gen.conf,g" /etc/contrail/supervisord_analytics_files/contrail-alarm-gen.ini && \
